...
//modelName is the name of our xdatamodel file (which will be compiled into momd)
...
- (NSURL *)storeURL {
    ...
    NSString *sqliteFile = [NSString
                            stringWithFormat:@"%@.sqlite", self.modelName];
    
    NSFileManager *fileManager =  [NSFileManager defaultManager];

    NSArray *docDirectories = [fileManager URLsForDirectory:NSDocumentDirectory inDomains:NSUserDomainMask];
                               
    NSURL *userDocsDirectory = [docDirectories firstObject];
    
    return [userDocsDirectory URLByAppendingPathComponent:sqliteFile];
